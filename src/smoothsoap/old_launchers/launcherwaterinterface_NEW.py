...
def run_simulation(methods):
    ...
    for name in tqdm(methods, 'methods'):
        ...
        for interval_idx, interval in enumerate(test_intervals):
            label = f'SOAP_interface_interval_{interval}_r{SOAP_cutoff}_maxang{SOAP_max_angular}_maxrad{SOAP_max_radial}'
            ...
            dir = f'results/waterinterface/CORRECT/SOAP_PCA/{name}'
