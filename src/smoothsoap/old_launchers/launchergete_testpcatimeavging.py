...
from src.smoothsoap.old_scripts.descriptors import eval_SOAP, SOAP_COV, SOAP_COV_repair, SOAP_PCA, SOAP_COV_test, SOAP_COV_directPCAtest, SOAP_COV_directPCAtestfull
